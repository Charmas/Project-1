    ...
    public class RestuarantAssignCouponToFoodController : ApiController
    {
        ...
        public string activeStatusAssignCoupon(int intAssignCouponToFoodMenandOuletID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusAssignCoupon = objAssignCoupon.manageAssignCouponToFoodMenu(5, intAssignCouponToFoodMenandOuletID, 0, intOutletID,0,0,"", 1,0, intCreatedBy,"", intModifiedBy, "");
        ...
        public string deactiveStatusAssignCoupon(int intAssignCouponToFoodMenandOuletID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int deactiveStatusAssignCoupon = objAssignCoupon.manageAssignCouponToFoodMenu(9, intAssignCouponToFoodMenandOuletID, 0, intOutletID, 0, 0, "",0, 0, intCreatedBy, "", intModifiedBy, "");
