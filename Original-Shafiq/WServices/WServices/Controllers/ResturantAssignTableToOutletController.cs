    ...
    public class ResturantAssignTableToOutletController : ApiController
    {
        ...
        public string activeStatusAssignTabletoOutlet(int intAssignTableToOutletID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusAssignTabletoOutlet = objAssignTabletoOutlet.manageAssignTableToOutlet(5, intAssignTableToOutletID, intOutletID, 0, 0, 0, "", 1, 0, intCreatedBy, "", intModifiedBy, "");
        ...
        public string deactiveStatusAssignTabletoOutlet(int intAssignTableToOutletID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int deactiveStatusAssignTabletoOutlet = objAssignTabletoOutlet.manageAssignTableToOutlet(9, intAssignTableToOutletID, intOutletID, 0, 0, 0, "", 0, 0, intCreatedBy, "", intModifiedBy, "");
