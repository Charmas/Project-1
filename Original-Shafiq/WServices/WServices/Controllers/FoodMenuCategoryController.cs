      ...
      //Get All Food Menu Category by ID///
        ...
        public string activeStatusFoodMenuCategoryDeactivate(int intFoodCategoryID,int intKitchenID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusFoodMenuCategoryDeactivate = objFoodMenuCategory.manageFoodMenuCategory(9, intFoodCategoryID, "", "", intKitchenID, intOutletID, 0, 0, intCreatedBy, "", intModifiedBy, "");
        ...
        public string activeStatusFoodMenuCategory(int intFoodCategoryID, int intKitchenID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusFoodMenuCategoryOn = objFoodMenuCategory.manageFoodMenuCategory(5, intFoodCategoryID, "", "", intKitchenID, intOutletID, 1,0, intCreatedBy, "", intModifiedBy, "");
