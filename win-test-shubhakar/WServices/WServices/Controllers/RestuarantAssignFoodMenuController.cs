    ...
    public class RestuarantAssignFoodMenuController : ApiController
    {
        ...
        public string activeStatusAssignFoodMenu(int intAssignModifierstoFoodMenuID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusAssignFoodMenu = objAssignFoodMenu.manageAssignFoodMenu(5, intAssignModifierstoFoodMenuID,0,0,0,"",1,0,intCreatedBy,"",intModifiedBy,"");
        ...
        public string deactiveStatusAssignFoodMenu(int intAssignModifierstoFoodMenuID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int deactiveStatusAssignFoodMenu = objAssignFoodMenu.manageAssignFoodMenu(9, intAssignModifierstoFoodMenuID, 0, 0, 0, "", 0, 0, intCreatedBy, "", intModifiedBy, "");
