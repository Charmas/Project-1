    ...
    public class KitchenInfoController : ApiController
    {
        ...
        public string deactiveStatusKitchenInfo(int intKitchenInfoID,int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int DeactiveStatusKitchenInfo = objKitchenInfo.manageKitchenInfo(9, intKitchenInfoID, "", intOutletID, 0,"",0,0,intCreatedBy,"",intModifiedBy,"");
        ...
        //Kitchen Required or not of KitchenInfo /////
        [Route("KitchenInfo/KitchenRequiredornotInfo")]
        [HttpPost]
        public string KitchenRequiredornotInfo(int intKitchenInfoID,int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {

                int KotchenRequiredornotInfo = objKitchenInfo.manageKitchenInfo(5, intKitchenInfoID, "", intOutletID, 0,  "", 0, 0, 0, "", 0, "");

                if (KotchenRequiredornotInfo == 0)
                {
                    return "Kitchen  Required Updated successfully";
                }
                else
                {
                    return "Error occured either component or strore Procedure";
        ...
        public string activeStatusKitchenInfo(int intKitchenInfoID, int intOutletID, int intCreatedBy, int intModifiedBy)
        {
            try
            {
                ...
                int activeStatusKitchenInfo = objKitchenInfo.manageKitchenInfo(5, intKitchenInfoID, "", intOutletID, 0, "", 1, 0,intCreatedBy, "", intModifiedBy, "");
