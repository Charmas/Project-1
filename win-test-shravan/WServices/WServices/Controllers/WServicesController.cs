...
namespace WServices.Controllers
{
    public class WServicesController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage getModulesSubModulesById(int intRoleId)
        {
            try
            {
        ...
        public HttpResponseMessage Assignvalue(string rolename)
        {
            try
            {
                ...
                int x = objRoles.USP_UPDATE_ROLE_MODULES_AND_SUBMODULES_Testing(intRoleID, "");
        ...
        public HttpResponseMessage AssignPermissionssss(int id)
        {
            try
            {
                ...
                for (int i = 0; i < intModuleCount; i++)
                {
                    ...
                    Module.MODULE_NAME = objJSONFlag2Response[i]["MODULE_NAME"].ToString();                //i.TBL_MODULES_MASTER.MODULE_NAME;
        ...
        public HttpResponseMessage UploadCompanyLogo()
        {
            ...
            if (!File.Exists(CompanyImagePath + Imagename))
            {
        ...
        public string readOutletinfoDetail()
        {
            try
            {
                ...
                string readOutletinfoDetail = objOutletInfo.getOutletInfo(1, 0, "", "", "", "", 0, "", 0,0, "", 1, 1, 0, "", 0, "");
